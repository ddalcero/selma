...
//					$ar['descuento']=$valores->pdays - $ar['imputado'];
	...
	public function post_actividad_update() {
		...
		if ($ok) return " Actividad OK. ";
		else return "Atención! No se ha podido actualizar OLGA.";
	...
	public function post_actividad_lote_update() {
		...
		if ($ok) return " Lote OK. ";
		else return "Atención! No se ha podido actualizar el lote.";
