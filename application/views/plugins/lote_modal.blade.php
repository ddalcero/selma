<div id="lote_modal" class="modal hide" data-backdrop="true" data-keyboard="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h3 class="modal_label">Modificar lote {{ $lote['lot_id'] }}</h3>
    </div>
    <div class="modal-body">
        <form id="lote_modal_form" method="POST" action="/lote/{{ $lote['lot_id'] }}" class="form-inline">
            ...
            <!-- Importe -->
            <div class="control-group">
              <label class="control-label" for="fechaLote">Fecha</label>
              <div class="controls">
                <input id="fechaLote" name="fechaLote" type="text" class="input-small" required="true" value="{{ ViewFormat::DateFromDB($lote['lot_date_previ_fac']) }}" required="">
              </div>
            </div>
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-primary" data-loading-text="Guardando..." onclick="$('#lote_modal_form').submit()">Guardar</button>
    </div>
</div>
