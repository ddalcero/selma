...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>{{ ((isset($title)?$title.' - ':'').Config::get('project.title')) }}</title>
        {{ Asset::styles() }}
        {{ Asset::scripts() }}
        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    <a class="brand" href="#"><img src="{{ asset('img/logo.png') }}" alt="{{ Config::get('project.title') }}" />
                    {{ Config::get('project.title') }}</a>
                    @section('navigation')
                    @yield_section
